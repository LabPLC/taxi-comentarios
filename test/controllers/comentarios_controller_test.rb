...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { coment: @comentario.coment, placa: @comentario.placa, usuario: @comentario.usuario }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { coment: @comentario.coment, placa: @comentario.placa, usuario: @comentario.usuario }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
